# Generated by Django 3.2 on 2023-02-20 10:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator('^[A-Za-z][A-Za-z0-9_]{7,29}$', message='Введите корректное username')], verbose_name='Имя пользователя')),
